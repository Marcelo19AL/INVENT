    ...
    <div class="header-carousel-item">
        ...
        <div class="carousel-caption">
            <div class="carousel-caption-content p-3">
                <h5 class="text-white text-uppercase fw-bold mb-4 prueba" style="letter-spacing: 3px;">Bienvenidos a </h5>
                <h1 class="display-1  text-white mb-4 prueba">Invent Formación e Investigación</h1>
                <p class="mb-5 fs-5 sec2">
                    Descubre cómo podemos ayudarte a alcanzar tus metas educativas y de investigación.
                </p>
